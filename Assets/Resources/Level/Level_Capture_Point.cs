...
[CreateAssetMenu(fileName = "new_capture_point_level", menuName = "ScriptableObjects/Level/CapturePointLevel")]
public class Level_Capture_Point : Level
{
    ...
    public override bool checkWinCondition()
    {
        ...
        foreach(CapturePoint capturePoint in MapManager.instance.capturePoints)
        {
            ...
            {
                if (!capturePoint.capturePointTilemapPositions.Contains(character.gridPos))
                {
                    return false;
                }
            }
